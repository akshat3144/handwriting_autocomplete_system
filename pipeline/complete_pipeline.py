...
sys.path.insert(0, str(parent_dir / 'phase1_ocr'))
sys.path.insert(0, str(parent_dir / 'phase2_nextword_prediction' / 'src'))
...
# OCR Model paths (update to actual model files in phase1_ocr/model_weights)
OCR_MODEL_PATH = parent_dir / 'phase1_ocr' / 'model_weights' / 'htr_model_20251106_201701_base.h5'
ENCODER_PATH = parent_dir / 'phase1_ocr' / 'model_weights' / 'encoder_20251106_201701.pkl'

# GPT-2 paths
GPT2_CHECKPOINTS_DIR = parent_dir / 'phase2_nextword_prediction' / 'checkpoints'
